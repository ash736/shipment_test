...
ActiveRecord::Schema[7.1].define(version: 2024_03_13_100538) do
  ...
  create_table "delivery_partners", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "active_for_delivery", default: false
    t.index ["email"], name: "index_delivery_partners_on_email", unique: true
    t.index ["reset_password_token"], name: "index_delivery_partners_on_reset_password_token", unique: true
  end
